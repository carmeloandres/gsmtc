...
?>
<!-- wp:heading {"className":"is-style-gsmtc-text-shadow","textAlign":"center","fontSize":"x-large"} -->
<h2 class="has-text-align-center has-x-large-font-size is-style-gsmtc-text-shadow">
	<?php esc_html_e( 'Page not found', 'gsmtc' ); ?></h2>
<!-- /wp:heading -->
<!-- wp:paragraph --><p><?php esc_html_e( 'It looks like nothing was found at this location. Maybe try a search?', 'gsmtc' ); ?></p><!-- /wp:paragraph -->
...
<h2 class="has-text-align-left"><?php esc_html_e( 'Latest posts', 'gsmtc' ); ?></h2>
<!-- /wp:heading -->
